...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Class.level'
        db.add_column('classes_class', 'level', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Class.system'
        db.add_column('classes_class', 'system', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Class.only_subject'
        db.add_column('classes_class', 'only_subject', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Class.level'
        db.delete_column('classes_class', 'level')

        # Deleting field 'Class.system'
        db.delete_column('classes_class', 'system')

        # Deleting field 'Class.only_subject'
        db.delete_column('classes_class', 'only_subject')
