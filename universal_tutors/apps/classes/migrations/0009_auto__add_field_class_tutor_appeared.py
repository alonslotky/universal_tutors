...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Class.tutor_appeared'
        db.add_column('classes_class', 'tutor_appeared', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Class.tutor_appeared'
        db.delete_column('classes_class', 'tutor_appeared')
