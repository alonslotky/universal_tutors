...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('classes_class', 'name')

        # Adding field 'Class.status'
        db.add_column('classes_class', 'status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('classes_class', 'status')
