...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.email_sent'
        db.add_column('profile_message', 'email_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.email_sent'
        db.delete_column('profile_message', 'email_sent')
