...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.test_class_id'
        db.add_column('profile_userprofile', 'test_class_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.test_class_id'
        db.delete_column('profile_userprofile', 'test_class_id')
