...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.price_per_hour'
        db.alter_column('profile_userprofile', 'price_per_hour', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.price_per_hour'
        db.alter_column('profile_userprofile', 'price_per_hour', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'profile.userprofile': {
            ...
            'price_per_hour': ('django.db.models.fields.FloatField', [], {'default': '-1', 'null': 'True'}),
