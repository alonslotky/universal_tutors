...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.is_new'
        db.add_column('profile_userprofile', 'is_new', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.is_new'
        db.delete_column('profile_userprofile', 'is_new')
