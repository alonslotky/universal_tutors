...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WithdrawItem.email'
        db.add_column('profile_withdrawitem', 'email', self.gf('django.db.models.fields.EmailField')(default='test@email.com', max_length=75), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WithdrawItem.email'
        db.delete_column('profile_withdrawitem', 'email')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 21, 16, 6, 44, 85526)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 21, 16, 6, 44, 85423)'}),
