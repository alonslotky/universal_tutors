...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.notifications_messages'
        db.add_column('profile_userprofile', 'notifications_messages', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.notifications_classes'
        db.add_column('profile_userprofile', 'notifications_classes', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserProfile.notifications_other'
        db.add_column('profile_userprofile', 'notifications_other', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.notifications_messages'
        db.delete_column('profile_userprofile', 'notifications_messages')

        # Deleting field 'UserProfile.notifications_classes'
        db.delete_column('profile_userprofile', 'notifications_classes')

        # Deleting field 'UserProfile.notifications_other'
        db.delete_column('profile_userprofile', 'notifications_other')
