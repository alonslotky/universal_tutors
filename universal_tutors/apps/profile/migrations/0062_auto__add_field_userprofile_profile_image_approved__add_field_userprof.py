...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.profile_image_approved'
        db.add_column('profile_userprofile', 'profile_image_approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.about_approved'
        db.add_column('profile_userprofile', 'about_approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.video_approved'
        db.add_column('profile_userprofile', 'video_approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.qualification_documents_approved'
        db.add_column('profile_userprofile', 'qualification_documents_approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.profile_image_approved'
        db.delete_column('profile_userprofile', 'profile_image_approved')

        # Deleting field 'UserProfile.about_approved'
        db.delete_column('profile_userprofile', 'about_approved')

        # Deleting field 'UserProfile.video_approved'
        db.delete_column('profile_userprofile', 'video_approved')

        # Deleting field 'UserProfile.qualification_documents_approved'
        db.delete_column('profile_userprofile', 'qualification_documents_approved')
