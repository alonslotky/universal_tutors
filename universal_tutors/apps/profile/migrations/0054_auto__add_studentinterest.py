...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudentInterest'
        db.create_table('profile_studentinterest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='interests', to=orm['auth.User'])),
            ('system', self.gf('django.db.models.fields.related.ForeignKey')(related_name='students', to=orm['classes.EducationalSystem'])),
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='students', to=orm['classes.ClassSubject'])),
            ('level', self.gf('django.db.models.fields.related.ForeignKey')(related_name='students', to=orm['classes.ClassLevel'])),
        ))
        db.send_create_signal('profile', ['StudentInterest'])

        # Removing M2M table for field interests on 'UserProfile'
        db.delete_table('profile_userprofile_interests')

    def backwards(self, orm):
        # Deleting model 'StudentInterest'
        db.delete_table('profile_studentinterest')

        # Adding M2M table for field interests on 'UserProfile'
        db.create_table('profile_userprofile_interests', (
        ...
        db.create_unique('profile_userprofile_interests', ['userprofile_id', 'classsubject_id'])
    ...
    models = {
        ...
        'profile.studentinterest': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'students'", 'to': "orm['classes.ClassLevel']"}),
            'subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'students'", 'to': "orm['classes.ClassSubject']"}),
            'system': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'students'", 'to': "orm['classes.EducationalSystem']"}),
        ...
        'profile.tutorsubject': {
            ...
            'system': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tutors'", 'to': "orm['classes.EducationalSystem']"}),
