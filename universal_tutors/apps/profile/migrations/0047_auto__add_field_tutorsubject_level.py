...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TutorSubject.level'
        db.add_column('profile_tutorsubject', 'level', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='tutors', to=orm['classes.ClassLevel']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TutorSubject.level'
        db.delete_column('profile_tutorsubject', 'level_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 15, 13, 4, 55, 584750)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 15, 13, 4, 55, 584647)'}),
