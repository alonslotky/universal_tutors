...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StudentReview'
        db.create_table('profile_studentreview', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviews_as_student', to=orm['auth.User'])),
            ('related_class', self.gf('django.db.models.fields.related.ForeignKey')(related_name='student_reviews', to=orm['classes.Class'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('profile', ['StudentReview'])

        # Adding field 'TutorReview.related_class'
        db.add_column('profile_tutorreview', 'related_class', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='tutor_reviews', to=orm['classes.Class']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'StudentReview'
        db.delete_table('profile_studentreview')

        # Deleting field 'TutorReview.related_class'
        db.delete_column('profile_tutorreview', 'related_class_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 14, 56, 47, 255546)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 14, 56, 47, 255438)'}),
        ...
        'profile.usercreditmovement': {
            'Meta': {'object_name': 'UserCreditMovement'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'credits': ('django.db.models.fields.FloatField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
