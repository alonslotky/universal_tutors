...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.min_credits'
        db.add_column('profile_userprofile', 'min_credits', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'UserProfile.max_credits'
        db.add_column('profile_userprofile', 'max_credits', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.min_credits'
        db.delete_column('profile_userprofile', 'min_credits')

        # Deleting field 'UserProfile.max_credits'
        db.delete_column('profile_userprofile', 'max_credits')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 18, 24, 36, 317357)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 18, 24, 36, 317251)'}),
