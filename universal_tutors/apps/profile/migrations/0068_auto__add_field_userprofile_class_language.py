...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile_userprofile', 'class_language', self.gf('django.db.models.fields.CharField')(default='en_US', max_length=6), keep_default=False)
    ...
    models = {
        ...
        'profile.userprofile': {
            ...
            'class_language': ('django.db.models.fields.CharField', [], {'default': "'en_US'", 'max_length': '6'}),
