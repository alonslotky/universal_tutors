...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile_userprofile', 'subjects',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tutors', null=True, to=orm['classes.ClassSubject']),
                      keep_default=False)
