...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserCreditMovement.value'
        db.add_column('profile_usercreditmovement', 'value', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)

        # Adding field 'UserCreditMovement.related_class'
        db.add_column('profile_usercreditmovement', 'related_class', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['classes.Class'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserCreditMovement.value'
        db.delete_column('profile_usercreditmovement', 'value')

        # Deleting field 'UserCreditMovement.related_class'
        db.delete_column('profile_usercreditmovement', 'related_class_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 18, 18, 22, 44, 566147)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 18, 18, 22, 44, 566045)'}),
