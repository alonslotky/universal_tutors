...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile_userprofile', 'scribblar_id',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Child.active'
        db.add_column('profile_child', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Child.key'
        db.add_column('profile_child', 'key',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.scribblar_id'
        db.delete_column('profile_userprofile', 'scribblar_id')

        # Deleting field 'Child.active'
        db.delete_column('profile_child', 'active')

        # Deleting field 'Child.key'
        db.delete_column('profile_child', 'key')

        # Adding unique constraint on 'Child', fields ['child']
        db.create_unique('profile_child', ['child_id'])
    ...
    models = {
        ...
        'profile.userprofile': {
            ...
            'scribblar_id': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
