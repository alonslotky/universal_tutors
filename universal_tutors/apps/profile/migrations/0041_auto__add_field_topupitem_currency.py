...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TopUpItem.currency'
        db.add_column('profile_topupitem', 'currency', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='topups', to=orm['core.Currency']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TopUpItem.currency'
        db.delete_column('profile_topupitem', 'currency_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 17, 15, 58, 45, 691402)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 17, 15, 58, 45, 691296)'}),
