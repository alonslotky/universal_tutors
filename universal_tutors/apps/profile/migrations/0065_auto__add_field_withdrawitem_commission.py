...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WithdrawItem.commission'
        db.add_column('profile_withdrawitem', 'commission', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WithdrawItem.commission'
        db.delete_column('profile_withdrawitem', 'commission')
