...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.crb_checked'
        db.add_column('profile_userprofile', 'crb_checked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.activated'
        db.add_column('profile_userprofile', 'activated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.activation_date'
        db.add_column('profile_userprofile', 'activation_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.crb_checked'
        db.delete_column('profile_userprofile', 'crb_checked')

        # Deleting field 'UserProfile.activated'
        db.delete_column('profile_userprofile', 'activated')

        # Deleting field 'UserProfile.activation_date'
        db.delete_column('profile_userprofile', 'activation_date')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 15, 17, 56, 2, 452018)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 15, 17, 56, 2, 451911)'}),
