...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profile_userprofile', (
            ...
            ('about', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ...
            ('newsletters', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('profile', ['UserProfile'])

        # Adding model 'NewsletterSubscription'
        db.create_table('profile_newslettersubscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('hash_key', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('profile', ['NewsletterSubscription'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profile_newslettersubscription')
