...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile_studentinterest', 'system', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='students', null=True, to=orm['classes.EducationalSystem']), keep_default=False)

        # Adding field 'StudentInterest.level'
        db.add_column('profile_studentinterest', 'level', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='students', null=True, to=orm['classes.ClassLevel']), keep_default=False)
