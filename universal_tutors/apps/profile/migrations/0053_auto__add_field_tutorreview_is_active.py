...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TutorReview.is_active'
        db.add_column('profile_tutorreview', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TutorReview.is_active'
        db.delete_column('profile_tutorreview', 'is_active')
