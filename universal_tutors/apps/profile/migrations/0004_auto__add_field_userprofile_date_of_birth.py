...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile_userprofile', 'date_of_birth', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 4, 5)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.date_of_birth'
        db.delete_column('profile_userprofile', 'date_of_birth')
