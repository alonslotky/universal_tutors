...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Child'
        db.create_table('profile_child', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='childs', to=orm['auth.User'])),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent', unique=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('profile', ['Child'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profile_child')

        # Adding field 'UserProfile.parent'
        db.add_column('profile_userprofile', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='childs', null=True, to=orm['auth.User'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'profile.child': {
            ...
            'child': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parent'", 'unique': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
