...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile_userprofile', 'currency', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Currency']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.currency'
        db.delete_column('profile_userprofile', 'currency_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 15, 11, 50, 10, 712369)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 15, 11, 50, 10, 712205)'}),
