...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.scribblar_id'
        db.alter_column('profile_userprofile', 'scribblar_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    def backwards(self, orm):

        # Changing field 'UserProfile.scribblar_id'
        db.alter_column('profile_userprofile', 'scribblar_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    models = {
        'auth.group': {
