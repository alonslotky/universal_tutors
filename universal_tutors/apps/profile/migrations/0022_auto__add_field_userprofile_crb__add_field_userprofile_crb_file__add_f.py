...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.crb'
        db.add_column('profile_userprofile', 'crb',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.crb_file'
        db.add_column('profile_userprofile', 'crb_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.apply_crb'
        db.add_column('profile_userprofile', 'apply_crb',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.crb'
        db.delete_column('profile_userprofile', 'crb')

        # Deleting field 'UserProfile.crb_file'
        db.delete_column('profile_userprofile', 'crb_file')

        # Deleting field 'UserProfile.apply_crb'
        db.delete_column('profile_userprofile', 'apply_crb')
    ...
    models = {
        ...
        'profile.userprofile': {
            ...
            'apply_crb': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
