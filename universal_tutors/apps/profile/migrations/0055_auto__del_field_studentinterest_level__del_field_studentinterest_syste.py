...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StudentInterest.level'
        db.delete_column('profile_studentinterest', 'level_id')

        # Deleting field 'StudentInterest.system'
        db.delete_column('profile_studentinterest', 'system_id')

    def backwards(self, orm):
        # Adding field 'StudentInterest.level'
        db.add_column('profile_studentinterest', 'level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='students', to=orm['classes.ClassLevel']),
                      keep_default=False)

        # Adding field 'StudentInterest.system'
        db.add_column('profile_studentinterest', 'system',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='students', to=orm['classes.EducationalSystem']),
                      keep_default=False)
