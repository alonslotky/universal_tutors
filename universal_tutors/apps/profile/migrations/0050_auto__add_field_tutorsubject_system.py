...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TutorSubject.system'
        db.add_column('profile_tutorsubject', 'system', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='tutors', to=orm['classes.EducationalSystem']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TutorSubject.system'
        db.delete_column('profile_tutorsubject', 'system_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 11, 7, 35, 847823)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 11, 7, 35, 847716)'}),
