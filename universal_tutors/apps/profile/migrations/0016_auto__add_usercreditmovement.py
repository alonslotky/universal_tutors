...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserCreditMovement'
        db.create_table('profile_usercreditmovement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='movements', to=orm['auth.User'])),
            ('type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('credits', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('profile', ['UserCreditMovement'])


    def backwards(self, orm):
        
        # Deleting model 'UserCreditMovement'
        db.delete_table('profile_usercreditmovement')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 11, 38, 18, 10157)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 11, 38, 18, 10042)'}),
