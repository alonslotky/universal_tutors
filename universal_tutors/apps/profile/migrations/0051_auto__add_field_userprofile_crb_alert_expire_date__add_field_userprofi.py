...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.crb_alert_expire_date'
        db.add_column('profile_userprofile', 'crb_alert_expire_date', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.crb_alert_expired'
        db.add_column('profile_userprofile', 'crb_alert_expired', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.crb_alert_expire_date'
        db.delete_column('profile_userprofile', 'crb_alert_expire_date')

        # Deleting field 'UserProfile.crb_alert_expired'
        db.delete_column('profile_userprofile', 'crb_alert_expired')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 20, 10, 37, 14, 27942)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 20, 10, 37, 14, 27840)'}),
