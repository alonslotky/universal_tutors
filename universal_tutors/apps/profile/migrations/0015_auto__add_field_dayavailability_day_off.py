...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DayAvailability.day_off'
        db.add_column('profile_dayavailability', 'day_off', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DayAvailability.day_off'
        db.delete_column('profile_dayavailability', 'day_off')
