...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.test_class_minutes'
        db.add_column('profile_userprofile', 'test_class_minutes', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=60), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.test_class_minutes'
        db.delete_column('profile_userprofile', 'test_class_minutes')
