...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TutorSubject'
        db.create_table('profile_tutorsubject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subjects', to=orm['auth.User'])),
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tutors', to=orm['classes.ClassSubject'])),
            ('credits', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('profile', ['TutorSubject'])

        # Deleting field 'UserProfile.subjects'
        db.delete_column('profile_userprofile', 'subjects_id')

        # Adding field 'UserProfile.video'
        db.add_column('profile_userprofile', 'video', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'TutorSubject'
        db.delete_table('profile_tutorsubject')

        # Adding field 'UserProfile.subjects'
        db.add_column('profile_userprofile', 'subjects', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tutors', null=True, to=orm['classes.ClassSubject'], blank=True), keep_default=False)

        # Deleting field 'UserProfile.video'
        db.delete_column('profile_userprofile', 'video')
