...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Referral.name'
        db.alter_column('profile_referral', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Referral.key'
        db.alter_column('profile_referral', 'key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))


    def backwards(self, orm):
        
        # Changing field 'Referral.name'
        db.alter_column('profile_referral', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Referral.key'
        db.alter_column('profile_referral', 'key', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 8, 16, 37, 51, 988791)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 8, 16, 37, 51, 988685)'}),
