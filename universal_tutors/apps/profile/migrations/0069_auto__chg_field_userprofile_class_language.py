...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.class_language'
        db.alter_column('profile_userprofile', 'class_language', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.class_language'
        db.alter_column('profile_userprofile', 'class_language', self.gf('django.db.models.fields.CharField')(max_length=6))
