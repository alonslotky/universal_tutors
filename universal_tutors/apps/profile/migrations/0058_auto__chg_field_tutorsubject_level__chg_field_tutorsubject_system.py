...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TutorSubject.level'
        db.alter_column('profile_tutorsubject', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['classes.ClassLevel']))

        # Changing field 'TutorSubject.system'
        db.alter_column('profile_tutorsubject', 'system_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['classes.EducationalSystem']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'TutorSubject.level'
        raise RuntimeError("Cannot reverse this migration. 'TutorSubject.level' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'TutorSubject.system'
        raise RuntimeError("Cannot reverse this migration. 'TutorSubject.system' and its values cannot be restored.")
