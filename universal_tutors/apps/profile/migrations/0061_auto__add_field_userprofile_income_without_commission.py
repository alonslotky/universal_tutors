...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.income_without_commission'
        db.add_column('profile_userprofile', 'income_without_commission', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.income_without_commission'
        db.delete_column('profile_userprofile', 'income_without_commission')
