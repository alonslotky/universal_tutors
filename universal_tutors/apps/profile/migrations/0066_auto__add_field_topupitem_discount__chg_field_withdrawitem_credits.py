...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TopUpItem.discount'
        db.add_column('profile_topupitem', 'discount', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='topups', null=True, to=orm['core.DiscountUser']), keep_default=False)

        # Changing field 'WithdrawItem.credits'
        db.alter_column('profile_withdrawitem', 'credits', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Deleting field 'TopUpItem.discount'
        db.delete_column('profile_topupitem', 'discount_id')

        # Changing field 'WithdrawItem.credits'
        db.alter_column('profile_withdrawitem', 'credits', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        'core.discount': {
            ...
            'discount_fixed': ('django.db.models.fields.FloatField', [], {}),
            'discount_percentage': ('django.db.models.fields.FloatField', [], {}),
