...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.profile_image'
        db.alter_column('profile_userprofile', 'profile_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    def backwards(self, orm):

        # Changing field 'UserProfile.profile_image'
        db.alter_column('profile_userprofile', 'profile_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    models = {
        'auth.group': {
        ...
        'profile.userprofile': {
            ...
            'profile_image': ('django.db.models.fields.files.ImageField', [], {'default': "'images/defaults/profile.jpg'", 'max_length': '100'}),
            ...
            'subjects': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tutors'", 'null': 'True', 'to': "orm['classes.ClassSubject']"}),
