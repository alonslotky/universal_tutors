...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TutorQualification'
        db.create_table('profile_tutorqualification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='qualifications', to=orm['auth.User'])),
        ...
        db.send_create_signal('profile', ['TutorQualification'])

        # Adding model 'Message'
        db.create_table('profile_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='received_messages', to=orm['auth.User'])),
            ('to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sent_messages', to=orm['auth.User'])),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('related_class', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='messages', null=True, to=orm['classes.Class'])),
        ))
        db.send_create_signal('profile', ['Message'])

        # Adding model 'TutorReview'
        db.create_table('profile_tutorreview', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviews', to=orm['auth.User'])),
            ('rate', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('profile', ['TutorReview'])

        # Adding model 'TutorFavorite'
        db.create_table('profile_tutorfavorite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='favorite_tutors', to=orm['auth.User'])),
            ('tutor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='students_has_favorite', to=orm['auth.User'])),
        ))
        db.send_create_signal('profile', ['TutorFavorite'])

        # Adding unique constraint on 'TutorFavorite', fields ['user', 'tutor']
        db.create_unique('profile_tutorfavorite', ['user_id', 'tutor_id'])

        # Adding field 'UserProfile.avg_rate'
        db.add_column('profile_userprofile', 'avg_rate', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'TutorFavorite', fields ['user', 'tutor']
        db.delete_unique('profile_tutorfavorite', ['user_id', 'tutor_id'])

        # Deleting model 'TutorQualification'
        db.delete_table('profile_tutorqualification')

        # Deleting model 'Message'
        db.delete_table('profile_message')

        # Deleting model 'TutorReview'
        db.delete_table('profile_tutorreview')

        # Deleting model 'TutorFavorite'
        db.delete_table('profile_tutorfavorite')

        # Deleting field 'UserProfile.avg_rate'
        db.delete_column('profile_userprofile', 'avg_rate')
