...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('profile_message', 'parent')

        # Adding field 'Message.child'
        db.add_column('profile_message', 'child', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_messages', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Message.parent'
        db.add_column('profile_message', 'parent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Message.child'
        db.delete_column('profile_message', 'child_id')
