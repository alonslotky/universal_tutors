...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UploadProfileImage'
        db.create_table('profile_uploadprofileimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('profile', ['UploadProfileImage'])

        # Changing field 'Message.message'
        db.alter_column('profile_message', 'message', self.gf('django.db.models.fields.CharField')(max_length=520))


    def backwards(self, orm):
        
        # Deleting model 'UploadProfileImage'
        db.delete_table('profile_uploadprofileimage')

        # Changing field 'Message.message'
        db.alter_column('profile_message', 'message', self.gf('django.db.models.fields.CharField')(max_length=500))
