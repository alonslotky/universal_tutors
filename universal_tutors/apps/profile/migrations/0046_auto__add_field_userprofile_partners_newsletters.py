...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.partners_newsletters'
        db.add_column('profile_userprofile', 'partners_newsletters',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.partners_newsletters'
        db.delete_column('profile_userprofile', 'partners_newsletters')
