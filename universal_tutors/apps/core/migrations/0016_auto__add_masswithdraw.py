...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MassWithdraw'
        db.create_table('core_masswithdraw', (
        ...
        db.send_create_signal('core', ['MassWithdraw'])

        # Adding M2M table for field items on 'MassWithdraw'
        db.create_table('core_masswithdraw_items', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('masswithdraw', models.ForeignKey(orm['core.masswithdraw'], null=False)),
            ('withdrawitem', models.ForeignKey(orm['profile.withdrawitem'], null=False))
        ))
        db.create_unique('core_masswithdraw_items', ['masswithdraw_id', 'withdrawitem_id'])

    def backwards(self, orm):
        # Deleting model 'MassWithdraw'
        db.delete_table('core_masswithdraw')

        # Removing M2M table for field items on 'MassWithdraw'
        db.delete_table('core_masswithdraw_items')
    ...
    models = {
        ...
        'core.masswithdraw': {
            'Meta': {'ordering': "['-created']", 'object_name': 'MassWithdraw'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'currency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Currency']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['profile.WithdrawItem']", 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'core.quote': {
