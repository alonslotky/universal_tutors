...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Discount.total_times'
        db.add_column('core_discount', 'total_times', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'Discount.total_times_used'
        db.add_column('core_discount', 'total_times_used', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Discount.total_times'
        db.delete_column('core_discount', 'total_times')

        # Deleting field 'Discount.total_times_used'
        db.delete_column('core_discount', 'total_times_used')
