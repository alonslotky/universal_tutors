...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DiscountUser.active'
        db.add_column('core_discountuser', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DiscountUser.active'
        db.delete_column('core_discountuser', 'active')
