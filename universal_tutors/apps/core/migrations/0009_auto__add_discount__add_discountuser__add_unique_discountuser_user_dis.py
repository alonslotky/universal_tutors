...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_discount', (
            ...
            ('code', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=15, unique=True, null=True, blank=True)),
            ('start', self.gf('django.db.models.fields.DateField')()),
            ('end', self.gf('django.db.models.fields.DateField')()),
            ('valid', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('discount_percentage', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('discount_fixed', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('core', ['Discount'])

        # Adding model 'DiscountUser'
        db.create_table('core_discountuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='discounts', to=orm['auth.User'])),
            ('discount', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', to=orm['core.Discount'])),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('core', ['DiscountUser'])

        # Adding unique constraint on 'DiscountUser', fields ['user', 'discount']
        db.create_unique('core_discountuser', ['user_id', 'discount_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'DiscountUser', fields ['user', 'discount']
        db.delete_unique('core_discountuser', ['user_id', 'discount_id'])

        # Deleting model 'Discount'
        db.delete_table('core_discount')

        # Deleting model 'DiscountUser'
        db.delete_table('core_discountuser')
    ...
    models = {
        ...
        'core.discount': {
            ...
            'code': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'max_length': '15', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'discount_fixed': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'discount_percentage': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'end': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start': ('django.db.models.fields.DateField', [], {}),
            'type': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'valid': ('django.db.models.fields.PositiveSmallIntegerField', [], {})
        },
        'core.discountuser': {
