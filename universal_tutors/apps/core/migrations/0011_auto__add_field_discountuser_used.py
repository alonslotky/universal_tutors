...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DiscountUser.used'
        db.add_column('core_discountuser', 'used', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DiscountUser.used'
        db.delete_column('core_discountuser', 'used')
