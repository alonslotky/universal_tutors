...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedbackQuestionOption.position'
        db.add_column('common_feedbackquestionoption', 'position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeedbackQuestionOption.position'
        db.delete_column('common_feedbackquestionoption', 'position')
    ...
    models = {
        ...
        'common.feedbackquestion': {
            'Meta': {'ordering': "['position', 'id']", 'object_name': 'FeedbackQuestion'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'common.feedbackquestionoption': {
            'Meta': {'ordering': "['position', 'id']", 'object_name': 'FeedbackQuestionOption'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.FeedbackQuestion']"}),
